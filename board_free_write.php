...
<body>
    ...
    <main>
        <section id="grid-bottom">
            ...
            <div class="item">
                <div class="write-box">
                    <form name="board" method="post" action="./php/board_free_create.php" enctype="multipart/form-data">
                        <div class="input-box">
                    ...
                    <div class="buttons">
                        ...
                        <button type="button" class="submit" onclick="location.href='./board_free.php?page=1'">취소</button>
                    </div>
                </div>
            </div>
        </section>
