...
<body>
    ...
    <main>
        <section id="grid-top">
            <div class="category">
                <a href="./board_info_workout.php">운동 루틴</a>
            </div>
            <div class="category">
                <a href="./board_info_diet.php">운동 식단</a>
            </div>
            <div class="category curr">
                <a href="./board_info_supplements.php">보조 식품</a>
            </div>
        </section>
        <section id="grid-bottom">
            <h3 style="text-align:center;">✨ 내가 먹는 보조식품❗️ 추천하고 싶은 것은?</h3>
            <div class="item all">
                <table>
                    <thead>
                        <tr>
                ...
                <?php
                    if($userid){
                ?>
                    <button class="write-button" onclick="location.href='./board_info_supplements_write.php'">글쓰기</button>
                <?php
                    } else {
                ?>
