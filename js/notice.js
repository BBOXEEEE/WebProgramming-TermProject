...
document.addEventListener("DOMContentLoaded", function() {
    window.addEventListener("load", function() {
        function loadNoticeBoard(page) {
            ...
            xhr.open('GET', `./php/board_notice_read.php?page=${page}`, true);
                ...
                if (xhr.status === 200) {
                    ...
                    if (data.length === 0) {
                        ...
                        data.forEach(list => {
                            ...
                            link.href = `./board_notice_view.php?num=${list.num}&page=${page}`;
        ...
        const xhr = new XMLHttpRequest();
        xhr.open('GET', './php/board_notice_read.php', true);
        xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
        xhr.onload = function() {
            if (xhr.status === 200) {
