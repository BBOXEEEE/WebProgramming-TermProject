...
<body>
    ...
    <main>
        <section id="grid-bottom"> 
            <h1 style="text-align:left;">📌 질의 응답</h1>
            <h3 style="text-align:left;">자유롭게 운동/식단에 대해 질문하고 답변해요❗️</h3>
            <div class="item all">
                <table>
                    <thead>
                        <tr>
                ...
                <?php
                    if($userid){
                ?>
                    <button class="write-button" onclick="location.href='./board_qna_write.php'">글쓰기</button>
                <?php
                    } else {
                ?>
