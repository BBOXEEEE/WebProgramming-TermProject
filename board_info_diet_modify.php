...
<body>
    ...
    ?>
        <section id="grid-bottom">
            ...
            <div class="item">
                <div class="write-box">
                    <form name="modify" method="post" action="./php/board_info_diet_update.php?num=<?=$num?>&page<?=$page?>" enctype="multipart/form-data">
                        <div class="input-box">
                    ...
                    <div class="buttons">
                        ...
                        <button type="button" class="submit" onclick="location.href='./board_info_diet.php?page=<?=$page?>'">취소</button>
                    </div>
                </div>
