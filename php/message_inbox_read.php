...
// 게시물 총 수 조회
$totalItemsQuery = "SELECT COUNT(*) AS total FROM message WHERE to_id = '$userid'";
...
$query = "SELECT * FROM message WHERE to_id = '$userid' ORDER BY regist_day DESC LIMIT $itemsPerPage OFFSET $offset";
